    ...
    def execute_signal(self, signal: Dict) -> Optional[Position]:
        ...
        try:
            ...
            if self.demo_mode:
                ...
                quantity = self.futures_client.format_quantity(symbol, quantity)
            else:
                self.set_leverage(symbol, settings.LEVERAGE)
